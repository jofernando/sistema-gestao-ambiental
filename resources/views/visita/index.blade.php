<x-app-layout>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    ...
                                                    @elseif ($visita->solicitacao_poda != null)
                                                        ...
                                                        <a title="Descrição" data-toggle="modal" data-target="#modal-texto-solicitacao-{{$visita->solicitacao_poda->id}}"><img class="icon-licenciamento" src="{{asset('img/eye.svg')}}" alt="Descrição"></a>
                                                        <a title="Mídia" data-toggle="modal" data-target="#modal-imagens-solicitacao-{{$visita->solicitacao_poda->id}}"><img class="icon-licenciamento" src="{{asset('img/media.svg')}}" alt="Mídia"></a>
                                                    @endif
                                                @endcan
                                            </td>
                                        </tr>
    ...
    @foreach ($visitas as $visita)
        @if ($visita->solicitacao_poda != null)
            ...
            @endphp
            <div class="modal fade" id="modal-texto-solicitacao-{{$solicitacao->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#2a9df4;">
                                <img src="{{ asset('img/logo_atencao3.png') }}" width="30px;" alt="Logo" style=" margin-right:15px; margin-top:10px;"/>
                        ...
                        <form id="formRequerimento" method="POST" action="">
                            ...
                            <div class="modal-body">
                                <div class="row form-row">
                                    <div id="avisoReq" class="col-12" style="font-family: 'Roboto', sans-serif; margin-bottom:10px;">Relato descrito pelo solicitante:</div>
                                    <div class="col-md-12 form-group">
