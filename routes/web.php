...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::post('/solicitacoes/atribuir/analista', [DenunciaController::class, 'atribuirAnalistaDenuncia'])->name('solicitacoes.atribuir.analista');
    ...
    Route::view('/solicitacoes/podas/create', '/solicitacoes/podas/create')->name('podas.create');
